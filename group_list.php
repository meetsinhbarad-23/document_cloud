			...
			echo'<table class="row-border">';
                        ...
                        if ($admin_num > 0)
                        {
	                        ...
	                        $grp_num = mysqli_num_rows($group);    
								...
								echo'<tr class="link-row" data-href="group/'.$group_d['group_id'].'">';
									echo'<td align="center">';
										echo '<img src="'.$grp_img.'" style="height:35px; width:35px;" class="circul">';		
									echo'</td>';
									echo'<td align="left">';
										echo '<a href="group/'.$group_d['group_id'].'">'.$group_d['name'].'</a>';		
									echo'</td>';
									echo'<td align="left">';
                        ...
                        if ($member_num > 0)
                        {
                            ...
                            $groupm = mysqli_query($con,"SELECT * FROM `group` WHERE group_id='$grp_idsm' AND status='Live' ");   
								...
								echo'<tr class="link-row" data-href="group/'.$group_md['group_id'].'">';
									...
									echo'</td>';
									echo'<td align="left">';
										echo '<a href="group/'.$group_md['group_id'].'">'.$group_md['name'].'</a>';		
									echo'</td>';
									echo'<td align="left">';
